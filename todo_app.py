...
class TodoApp(QMainWindow):
    ...
    def initUI(self):
        ...
        add_item_description = QLabel("<strong>Check, prioritize, edit or delete your tasks.</strong> If checked, the task moves downwards to the list of completed tasks.")
        add_item_description.setObjectName("description")
        main_layout.addWidget(add_item_description)
        ...
        completed_item_description = QLabel("<strong>Uncheck, prioritize, edit or delete your completed tasks.</strong> If unchecked, the task moves upwards to the list of tasks.")
    ...
    def update_list(self):
        ...
        for index, item in enumerate(self.items):
            if item[0] == "0":
                self.add_list_item(self.list_widget, index, item, f"Added on {item[3]}")
            else:
                self.add_list_item(self.completed_list_widget, index, item, f"Completed on {item[4]}")
